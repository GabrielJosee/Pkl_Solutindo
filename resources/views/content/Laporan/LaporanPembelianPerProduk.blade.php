...
@section('content')
    ...
    <h3 class="page-title">
        <b>Laporan Pembelian per Produk</b> <small>Mengelola Pembelian per Produk</small>
    </h3>
    <br/>
    <div id="accordion">
        <form method="post" action="{{route('filter-laporan-pembelian-per-produk')}}" enctype="multipart/form-data">
            @csrf
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="form-actions float-right">
                <button onclick="location.href='{{ url('/laporan-pembelian-per-produk/cetak-pdf') }}'" class="btn btn-sm btn-info"
                    title="Add Data" style="margin-left: 5px">Print PDF
                </button>
                <button onclick="location.href='{{ url('/laporan-pembelian-per-produk/cetak-excel') }}'" class="btn btn-sm btn-info"

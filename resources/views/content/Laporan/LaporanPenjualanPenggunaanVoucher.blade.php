...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Laporan Penjualan Penggunaan Voucher</li>
        </ol>
    </nav>
...
@section('content')
    ...
    <h3 class="page-title">
        <b>Laporan Penjualan Penggunaan Voucher</b> <small>Mengelola Penjualan Penggunaan Voucher</small>
    </h3>
    <br />
    <div id="accordion">
        <form method="post" action="{{ route('filter-laporan-penjualan-penggunaan-voucher') }}"
                ...
                <table id="example" style="width:100%"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style='text-align:center'>Nominal Voucher</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($sales as $sls)
                            <tr>
                                <td width="20%" style='text-align:center'>{{ $sls['sales_no'] }}</td>
                                <td width="20%" style='text-align:center'>{{ $sls['sales_date'] }}</td>
                                <td width="20%" style='text-align:center'>{{ $sls->callCustomer['customer_name'] }}</td>
                                <td width="20%" style='text-align:center'>{{ $sls->callVoucher['vouchers_name'] }}</td>
                                <td width="20%" style='text-align:right'>Rp{{ str_replace(',', '.', number_format($sls['vouchers_nominal'])) }},00</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>

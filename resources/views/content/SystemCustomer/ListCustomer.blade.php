...
@section('content')
    ...
    <h3 class="page-title">
        <b>Daftar Customer</b> <small>Mengelola System Customer </small>
    </h3>
    <br/>
    ...
    <div class="card border border-dark">
        <div class="card-header bg-dark clearfix">
            ...
            <div class="form-actions float-right">
                <button onclick="location.href='{{ url('customer/tambah') }}'" name="" class="btn btn-sm btn-info"
                    title="Add Data"><i class="fa fa-plus"></i> Tambah Costumer Baru</button>
                <button onclick="location.href='{{ url('/cetak-customer') }}'" class="btn btn-sm btn-info" title="Add Data"
                    style="margin-left: 5px">Print PDF
                </button>
                <button onclick="location.href='{{ url('/cetak-customer-excel') }}'" class="btn btn-sm btn-info"

...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daftar Produk Expired</li>
        </ol>
    </nav>
...
@section('content')
    ...
    <h3 class="page-title">
        <b>Daftar Produk Expired</b> <small>Mengelola Expired</small>
    </h3>
    <br />
    @if (session('msg'))
                    ...
                    <tbody>
                        ...
                        @foreach ($expired  as $exp)
                            <tr>
                                ...
                                <td style='text-align:center' width='10%'>{{ $exp['expired_date'] }}</td>

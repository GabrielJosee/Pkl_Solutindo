...
<div class="card border border-dark">
    ...
    <form method="" action="/productcategory/tambah/process" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="product_category_code" id="product_name"/>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <a class="text-dark">Nama Produk Kategori<a class='red'> *</a></a>
                        <input class="form-control input-bb" type="text" name="product_category_name" id="product_price"/>
                    </div>
                </div>
            </div>
        </div>

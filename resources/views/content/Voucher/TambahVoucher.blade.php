...
<div class="card border border-dark">
    ...
    <form method="" action="/vouchers/tambah/process" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="vouchers_name" id="vouchers_name"
                            value="" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="date" name="start_date" id="start_date"
                            value="" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="date" name="end_date" id="end_date"
                            value="" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="number" name="nominal" id="nominal"
                            value="" />
                    </div>
                </div>
            </div>

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <!-- Background Video-->
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="{{ asset('resources/assets/mp4/video.mp4') }}" type="video/mp4" /></video>
        <!-- Masthead-->
        <div class="masthead">
            ...
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <img src="{{asset('resources/img/logosmart/foto.png')}}" id="logo" style="width: 500px; height: 500px; justify-content:center;">
        ...
        <div style="position:absolute; bottom: 0; right:0; color:beige;">
            <a>www.ciptasoluindo.id</a>
        </div>
        <!-- Social Icons-->
